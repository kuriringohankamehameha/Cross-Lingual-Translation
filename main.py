...
for efile, dfile in zip(eng_list, dut_list):
    ...
    if count == 0:
        ...
        OUTPUT_FILE5 = OUTPUT_PATH + 'q_' + str(count-1) + '.txt'
        if count <= 1:
            prob_dict, counter, total, total_s = ibm_model.get_prob_dict_from_file_no_q(OUTPUT_FILE1, OUTPUT_FILE2, OUTPUT_FILE3, OUTPUT_FILE4)
        else:
            prob_dict, counter, total, total_s, q = ibm_model.get_prob_dict_from_file(OUTPUT_FILE1, OUTPUT_FILE2, OUTPUT_FILE3, OUTPUT_FILE4, OUTPUT_FILE5)
